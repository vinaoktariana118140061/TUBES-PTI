...
<div class="f"> 
<i class="fa fa-tasks">Manajemen</i>
</div>
</fieldset>
<div class="MP">Manajemen Pemasok</div>
<Div>
    <button type="submit" id="tambahpemasok" value="tambahpemasok" class="b5">Tambah Pemasok </button>
    <button type="submit" id="cetakdata" value="cetakdata" class="b6">Cetak Data Pemasok </button><br>
    </Div>
    <div class="box_DP">
